...
class slash_commands(commands.Cog):
    ...
    async def mute_message(self, interaction: discord.Interaction):
        ...
        message = await channel.send(f"# SI PUEDES VER ESTE CANAL SIGNIFICA QUE FUISTE MUTEADO, ESPERA A QUE TERMINE LA SANCIÓN PARA PODER CHARLAR NUEVAMENTE. REVISA TU MENCIÓN EN  <#{mention_channel_id}>")
